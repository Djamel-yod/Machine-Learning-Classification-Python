...
st.write("Cette application est destinée a prédire si un client de la société de télécommunication est susceptible de résilier son contract ou non en utilisant un algorithme de Machine Learning qui offre une grande présicion. Elle prend en entrée certaines données sur l'abonné(e).")
